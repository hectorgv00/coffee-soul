...
if (isset($_GET['envio'])) {
	...
	print_r($datosbonitos);
	try {
		if (file_put_contents($archivo, $datosbonitos) === false) {
			throw new Exception("Error al escribir en el archivo $archivo");
		}
	} catch (Exception $e) {
		echo 'Excepción capturada: ',  $e->getMessage(), "\n";
		if (!is_writable(dirname($archivo))) {
			echo 'El directorio no tiene permisos de escritura: ', dirname($archivo), "\n";
		}
	}
	echo "ok";
}
